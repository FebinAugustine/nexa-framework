...
const actions = {
    ...
    setCurrentArticle: (state: any, article: any) => {
    ...
    addArticle: (state: any, article: any) => {
        state.articles.set([...state.articles.get(), article]);
    },
    updateArticle: (state: any, article: any) => {
        state.articles.set(state.articles.get().map((a: any) => 
            a.id === article.id ? article : a
        ));
    },
    deleteArticle: (state: any, articleId: any) => {
        state.articles.set(state.articles.get().filter((a: any) => a.id !== articleId));
    }
};
